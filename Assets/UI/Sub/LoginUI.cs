        ...
        public override void Init() {
            ...
            home_login.onClick.AddListener(() => {
                ...
                homePanel.DOFade(0,0.5f).OnComplete(() => {
                    ...
                    sphere.DOAnchorPosY(sphere_radius,1f);
            ...
            login_back.onClick.AddListener(() => {
                loginPanel.DOFade(0,0.5f).OnComplete(() => {
                    ...
                    sphere.DOAnchorPosY(263+sphere_radius,1f).SetEase(Ease.Linear);
            ...
            home_register.onClick.AddListener(() => {
                homePanel.DOFade(0,0.5f).OnComplete(() => {
                    ...
                    sphere.DOAnchorPosY(140+sphere_radius,1f);
                    sphereCamera.DOColor(black,1f);
                });
            });
            ...
            login_enter.onClick.AddListener(() => {
                ...
                loginPanel.DOFade(0,0.5f).OnComplete(() => {
                    ...
                    sphere.DOScale(0.8f*sphere_diameter,1f).SetEase(Ease.Linear);
                    sphere.DOAnchorPosY(0, 1f).SetEase(Ease.Linear).OnComplete(() => {
                        // 进度条移动
